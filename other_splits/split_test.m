function split_test(training_ratio) 
    % load data and get input and output data as matricies
    
    [training_data, testing_data] = utils.split_and_load_data(training_ratio);
    ...
    fprintf("\n--------------------------------------------------\n");
    fprintf("             Average Normalized RMSEs: " + training_ratio * 10 + "% Training");
    fprintf("--------------------------------------------------\n");
    ...
    utils.graph_model_accuracy(training_ratio, model_names, avg_norm_rmses);
end